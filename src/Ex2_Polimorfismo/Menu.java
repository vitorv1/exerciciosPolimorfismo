...
public abstract class Menu {
    ...
    public static void menuFolhaPagamento(){
        ...
        System.out.println("NOME: " + funcionario.getNome() + "  " + "CARGO: " + funcionario.getTipo() + "  " + "SALARIO BRUTO: " + funcionario.getSalario());
        System.out.println("SALARIO LINQUIDO: " + salario + "  " + "DESCONTOS: " + "5% DO SINDICATO" + "  " + funcionario.getDesconto() + "IMPOSTO DE RENDA");
    }
